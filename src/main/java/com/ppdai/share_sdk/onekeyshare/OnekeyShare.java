...
package com.ppdai.share_sdk.onekeyshare;
...
public class OnekeyShare {
	...
	private ArrayList<CustomerLogo> getCustomerLogoList(){
		if(themeImpl==null)return null;
		return themeImpl.customerLogos;
	}
